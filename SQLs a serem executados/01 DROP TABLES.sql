...
IF (EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES
			WHERE ROUTINE_NAME ='PROC_GERA_CODIGO_USUARIO'))
BEGIN
...
IF (EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES
			WHERE ROUTINE_NAME ='FUNC_BUSQUE_CARONAS'))
BEGIN
	DROP FUNCTION FUNC_BUSQUE_CARONAS;
END;

-------------------------Destrói todas as triggers------------------------
IF EXISTS (SELECT * FROM sys.objects WHERE [name] = N'TRG_GERA_COD_USUARIO' AND [type] = 'TR')
BEGIN
...
IF EXISTS (SELECT * FROM sys.objects WHERE [name] = N'TRG_INATIVA_USUARIO' AND [type] = 'TR')
BEGIN
      DROP TRIGGER TRG_INATIVA_USUARIO;
END;
...
DROP INDEX IND_VEICULO ON VEICULO;
DROP INDEX IND_CARONA ON CARONA;
